...
export function DataTablePagination<TData>({
  ...
  let classPosition = "justify-center";
  if(position === "center") {
    classPosition = "justify-center";
  }else if(position === "left") {
    classPosition = "justify-start";
  }else if(position === "right") {
    classPosition = "justify-end";
  }

  return (
    <div className={`flex items-center ${classPosition} space-x-2 py-4`}>
